...
using ProjetoTALP_ControleDespesas.ConsultaDespesa;
...
namespace ProjetoTALP_ControleDespesas
{
    public partial class FormControleDespesas : Form
    {
        ...
        /// <summary>
        /// Método para direcionar ao formConsultaDespesaPorId.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void iDToolStripMenuItem_Click(object sender, EventArgs e)
        {
            FormConsultaDespesaPorId frmId = new FormConsultaDespesaPorId();
            frmId.Show();
        }
        /// <summary>
        /// Método para direcionar ao formConsultaPorNome.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void nomeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            FormConsultaPorNome frmNome = new FormConsultaPorNome();
            frmNome.Show();
        }
    }
}
